...
import com.paddi.utils.StringUtil;
...
/**
 * refer to dubbo spi: <a href="https://cn.dubbo.apache.org/zh/docsv2.7/dev/source/dubbo-spi/">...</a>
 * @Author: Paddi-Yan
 * @Project: paddi-rpc-framework
 * @CreatedTime: 2023年01月28日 10:30:55
 */
@Slf4j
public final class ExtensionLoader<T> {
    ...
    public static <S> ExtensionLoader<S> getExtensionLoader(Class<S> type) {
        ...
        //firstly get from cache, if not hit, then create one
    ...
    private void loadResource(Map<String, Class<?>> classes, ClassLoader classLoader, URL resourceUrl) {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(resourceUrl.openStream(), UTF_8))){
            ...
            while((line = reader.readLine()) != null) {
                ...
                if(ci >= 0) {
                    //string after # is comment, so we should ignore it
